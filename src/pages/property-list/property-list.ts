...
import {Config, NavController,LoadingController, Loading} from 'ionic-angular';
...
export class PropertyListPage {
   ...
   loading: Loading;
    ...
    map;
    markersGroup;
    constructor(public loadingCtrl: LoadingController,public navCtrl: NavController, public service: PropertyService, public config: Config,private http:Http) {
